<div class="sidebar" id="side-nav">
    <ul class="list-unstyled px-2">
        <img class="rounded-circle mx-auto d-block" src="{{ asset('assets/img/Ellipse 5.png') }}" />
        <h2 class="text-center text-white mb-2">Subur Jaya</h2>
        <p class="text-center text-white">PT. Al-Jabbar</p>
