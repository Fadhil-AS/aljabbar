...
@section('container')
        ...
        <div class="container-fluid mt-5" style="margin-bottom: 150px">
            <div class="container">
                ...
                <div class="fiturSamping col-md-9 mb-4 mt-5 d-flex" style="padding: 50px">
                ...
                <div class="fitur col-md-9 mb-5 mt-4">
                    <div class="card mb-5 border-0">
                        <div class="row no-gutters">
                            <div class="col-md-6" style="display: flex; flex: wrap;">
                                <img src="https://images.unsplash.com/photo-1548345680-f5475ea5df84?auto=format&fit=crop&q=80&w=2073&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="card-img-top" alt="..." style="height: 290px; width: 450px;">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="card mt-5 mb-5 border-0">
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-6" style="display: flex">
                                <img src="https://images.unsplash.com/photo-1585583416718-5bea75d5312a?auto=format&fit=crop&q=80&w=2070&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="card-img-top" alt="..." style="height: 290px; width: 450px;">
                            </div>
                        </div>
                    </div>
                </div>
