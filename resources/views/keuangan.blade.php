...
@section('container')
    ...
    <div class="container-fluid mt-5" style="margin-bottom: 150px">
        <div class="container">
            {{-- header --}}
            <div class="text-center justify-content-center " style="padding: 50px; margin-top: 50px;">
            ...
            {{-- Card Fitur --}}
            <div class="row justify-content-center" style="padding: 50px; margin-top: 50px;">
                <div class="col-md-4">
        ...
        {{-- Fitur --}}
        <div class="cardFitur col-md-9 mb-5 mt-5">
            <div class="card mb-5 border-0" style="width: 50%;">
                <div class="row no-gutters">
                    <div class="col-md-6">
                        <img src="https://images.unsplash.com/photo-1561414927-6d86591d0c4f?auto=format&fit=crop&q=80&w=1973&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="card-img rounded" alt="...">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card mb-5 mt-5 border-0" style="width: 50%;">
                <div class="row no-gutters">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <img src="https://images.unsplash.com/photo-1591696205602-2f950c417cb9?auto=format&fit=crop&q=80&w=2070&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="card-img rounded" alt="...">
                    </div>
                </div>
            </div>
        </div>
