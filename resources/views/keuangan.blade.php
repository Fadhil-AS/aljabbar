...
@section('container')
    ...
    <div class="text-center justify-content-center mt-5">
        ...
        <h5 class="text-secondary fw-normal mb-5">Kendalikan keuangan perusahaan dengan mudah. Monitor dan optimalkan pengeluaran dan pendapatan perusahaan bersama Transport Berkah Armada</h5>
    </div>

    {{-- Card Fitur --}}
    <div class="cardGroup mt-5 d-flex col-md-7 mb-5 mt-5">
        <div class="card1 shadow-lg rounded border border-0" style="width: 25rem;">
        ...
        <div class="card2 shadow-lg rounded border border-0" style="width: 25rem;">
            <div class="card-body mt-5">
    ...
    {{-- Fitur --}}
    <div class="cardFitur col-md-7 mb-5 mt-5">
        <div class="card shadow-lg rounded border border-0">
        ...
        <div class="card card shadow-lg rounded border border-0 mt-5 mb-5">
            <div class="row no-gutters">
                <div class="col-md-6">
