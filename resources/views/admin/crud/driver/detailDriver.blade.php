...
@section('containAdmin')
    ...
    <div class="container">
        <div class="card mb-3 border-0 shadow" style="max-width: 100%;">
            <div class="row g-0">
                <div class="col-md-2">
                    <img src="{{ asset($dataDrv->foto_profile) }}" class="rounded-circle mt-3 ms-3 mb-3 me-3"
                        ...
                        <div class ="profil-driver">
                            ...
                            <table class="mt-3 mb-5">
                                <tr>
                                    ...
                                    <td>
                                        <h4 class="me-5 mb-4">{{ $dataDrv->tgl_lahir }}</h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <h4 class="me-5 mb-4">{{ $dataDrv->nik }}</h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <h4 class="me-5 mb-4">{{ $dataDrv->email }}</h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <h5 class="me-5 mb-4">Nomor SIM</h5>
                                    </td>
                                    <td>
                                        <h4 class="me-5 mb-4">{{ $dataDrv->nomor_sim }}</h4>
                                    </td>
                                </tr>
                            </table>
                        </div>
