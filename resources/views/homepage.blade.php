...
@section('container')
    ...
    <div class="about">
        ...
        <button class="btn btn-success btnBergabung shadow-lg rounded" type="button">Bergabung dengan kami!</button>
        <div class="cardGroup d-flex cardAbout container-fluid">
            <div class="card shadow-lg rounded border-0" style="width: 18rem;">
    ...
    <div class="testimoni">
        ...
        <div class="cardGroup d-flex cardTesti container-fluid">
            <div class="card shadow-lg rounded border-0" style="width: 18rem;">
                ...
                <div class="card-body">
                    <h3>Asep</h3>
                    <p class="card-text text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium eius quam dolorum repudiandae accusantium earum assumenda dignissimos iure praesentium saepe. Laudantium esse placeat dolorum, odit ratione nostrum aspernatur quae consequatur!.</p>
                </div>
            </div>
            <div class="card shadow-lg rounded border-0" style="width: 18rem;">
              ...
              <div class="card-body">
                <h3>Lilis</h3>
                <p class="card-text text-secondary">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ad accusamus expedita quos rem deserunt quam dignissimos aperiam, quae nam laudantium voluptas numquam, ipsum nemo, assumenda voluptatum explicabo iusto error perferendis?</p>
              </div>
            </div>
            <div class="card shadow-lg rounded border-0" style="width: 18rem;">
            ...
            <div class="card shadow-lg rounded border-0" style="width: 18rem;">
                ...
                <div class="card-body">
                    <h3>Ayu</h3>
                    <p class="card-text text-secondary">but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software.</p>
                </div>
            </div>
        </div>
    </div>
