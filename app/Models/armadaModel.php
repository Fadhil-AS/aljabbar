...
class armadaModel extends Model
{
    ...
    protected $fillable = ['plat_depan', 'nomor_plat', 'plat_belakang', 'tgl_kir', 'julukan', 'kelas', 'foto_armada', 'jarak_tempuh', 'kapasitas_kursi', 'nomor_body', 'status', 'tempat_awal', 'tempat_akhir', 'jam_keberangkatan', 'tanggal_keberangkatan','penumpang','id_driver', 'id_helper'];
